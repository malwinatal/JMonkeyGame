...
public class Enemy {
    ...
    public void runGolemRun(float playerLocX, float playerLocZ, boolean[] directions){
        ...
        if(/*golem.getLocalTranslation().x>playerLocX &&*/ directions[0]){golem.move(-speed, 0, 0); }
        else if(/*golem.getLocalTranslation().x<playerLocX &&*/ directions[1]){golem.move(speed, 0, 0); }
        else if(/*golem.getLocalTranslation().z>playerLocX &&*/ directions[2]){golem.move(0, 0, -speed); }
        else if(/*golem.getLocalTranslation().z<playerLocX &&*/ directions[3]){golem.move(0, 0, speed);}
